...
namespace TetrisApp
{
    ...
    class Tetris :ITetris
    {
        ...
        /* Инициализируем экземпляр класса, который отвечает за запись результатов
         * в текстовый файл и считывания с него.
         */
        public ITetris InitResults()
        {
            _playerResults = new PlayerResults();
            return this;
        }
        ...
        public void Play()
        {
            ...
            _playerResults.SaveResults(map.GameData);
        }
